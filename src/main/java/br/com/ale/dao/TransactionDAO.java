...
public class TransactionDAO {
  ...
  public List<Transaction> selectFromAccountId(Connection conn, Long fromAccountId) {
    ...
    try (PreparedStatement stmt = conn.prepareStatement(sql)) {
      ...
      throw new RuntimeException(
          "Database error while selecting transactions " + "[fromAccountId=" + fromAccountId + "]",
          e);
    }
  }
  ...
  public List<Transaction> selectToAccountId(Connection conn, Long toAccountId) {
    ...
    try (PreparedStatement stmt = conn.prepareStatement(sql)) {
      ...
      throw new RuntimeException(
          "Database error while selecting transactions " + "[toAccountId=" + toAccountId + "]", e);
    }
  }
  ...
  public List<Transaction> selectByAccountId(Connection conn, Long accountId) {
    ...
    try (PreparedStatement stmt = conn.prepareStatement(sql)) {
      ...
      throw new RuntimeException(
          "Database error while selecting transactions " + "[accountId=" + accountId + "]", e);
    }
  }
