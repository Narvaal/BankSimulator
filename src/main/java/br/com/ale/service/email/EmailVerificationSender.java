...
public class EmailVerificationSender {
  ...
  public EmailVerificationSender(EmailService emailService, EmailTemplateService templateService) {
  ...
  public void sendVerificationEmail(Client client, String token) {
    ...
    String html =
        templateService.buildVerifyEmailTemplate(Objects.toString(client.getName(), "User"), link);

    try {

      emailService.send(email, "Confirm your account", html);
  ...
  public void sendPasswordReset(Client client, String token) {
    ...
    String html =
        templateService.buildResetPasswordTemplate(
            Objects.toString(client.getName(), "User"), link);
