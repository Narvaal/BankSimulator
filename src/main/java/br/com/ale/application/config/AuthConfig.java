...
public class AuthConfig {
  ...
  public AuthService authService(
      ConnectionProvider connectionProvider, TokenGenerator tokenGenerator) {
  ...
  @Bean
  public PrivateKeyStorage privateKeyStorage(@Value("${db.use.test:false}") boolean useTestDb) {
    return useTestDb ? new InMemoryPrivateKeyStorage() : new FilePrivateKeyStorage();
  }
  ...
  public VerifyAccountUseCase verifyAccountUseCase(
      ...
      ClientService clientService,
      JwtService jwtService) {
    return new VerifyAccountUseCase(emailVerificationService, clientService, jwtService);
  }
  ...
  public ResendVerificationUseCase resendVerificationUseCase(
    ...
    return new ResendVerificationUseCase(
        clientService, emailVerificationService, emailVerificationSender);
  }
  ...
  public ChangePasswordUseCase changePasswordUseCase(
    ...
    return new ChangePasswordUseCase(clientService, emailVerificationService);
  }
  ...
  public GetClientProfileUseCase getClientProfileUseCase(
      ClientService clientService, AuthService authService) {
    return new GetClientProfileUseCase(clientService, authService);
  }

  @Bean
  public GetPublicAccountProfileUseCase getPublicAccountProfileUseCase(
      AccountService accountService) {
  ...
  public ListTransfersByAccountUseCase listTransfersByAccountUseCase(
    ...
    return new ListTransfersByAccountUseCase(transactionService, accountService, authService);
  }
}
