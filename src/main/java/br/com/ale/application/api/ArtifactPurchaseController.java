...
import br.com.ale.dto.PurchaseArtifactApiRequest;
...
public class ArtifactPurchaseController {
    ...
    public ArtifactPurchaseController(PurchaseArtifactUseCase purchaseArtifactUseCase, AuthCookieService authCookieService) {
