...
public class ArtifactQueryController {
    ...
    private final ListArtifactPriceHistoryByArtifactIdUseCase listArtifactPriceHistoryByArtifactIdUseCase;
    ...
    public ArtifactBundleResponse createBundle(@RequestBody CreateArtifactBundleApiRequest request) {
        return createArtifactBundleUseCase.execute(new CreateArtifactBundleCommand(request.assets(), request.identifier()));
    }
