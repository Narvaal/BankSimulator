...
public class ListAssetPriceHistoryByAssetIdUseCase {

    private final AssetPriceHistoryService assetPriceHistoryService;

    public ListAssetPriceHistoryByAssetIdUseCase(
            AssetPriceHistoryService assetPriceHistoryService
    ) {
        this.assetPriceHistoryService = assetPriceHistoryService;
    }

    public List<AssetPriceHistory> execute(long assetId) {
        return assetPriceHistoryService.listByAssetId(assetId);
    }
}
