...
async function getBundleAssets(id: string): Promise<Asset[]> {
    ...
    const res = await fetch(
        `https://BankSimulator.us-east-2.elasticbeanstalk.com/assets/bundles/${id}/items?page=0&size=20`
    );
...
async function claimAsset(assetId: number) {
    ...
    const res = await fetch("https://BankSimulator.us-east-2.elasticbeanstalk.com/assets/claim", {
        method: "POST",
        credentials: "include",
        headers: {
