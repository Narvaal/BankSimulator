...
class AuthServiceTest {
  ...
  void shouldAuthenticateSuccessfully() {
    ...
    AuthToken token =
        authService.authenticate(new CreateAuthenticationRequest(client.getEmail(), rawPassword));
    ...
    assertThrows(
        ...
        () ->
            authService.authenticate(
                new CreateAuthenticationRequest("nonexistent@test.com", "any-password")));
  }
  ...
  void shouldFailWhenPasswordIsInvalid() {
    ...
    assertThrows(
        ...
        () ->
            authService.authenticate(
                new CreateAuthenticationRequest(client.getEmail(), "wrong-password")));
  }
}
